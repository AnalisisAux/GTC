...
<?php   
        ...
        <form method="post" action="<?=$_SERVER["PHP_SELF"]?>" class="row g-3">
            <h2>Datos de cliente</h2>
                ...
                <select name="activo">
                    <option value="Sin verificar" <?php if($activo=='Sin verifica'){echo 'selected';}?>>Sin verificar</option>
...
//Asignacion de variables para el update
                ...
                if (isset($_POST['Actualizar'])){
                    ...
                    Estado='$EstadoT',Codigopostal='$CodigopostalT',
                    PDF ='$file' WHERE Numref = $NumrefT";
    ...
    <div class="container-sm">
      ...
      <form method = "post">
        <h3>Constancia</h3>
        <embed src="Formulario/RFCprueba.pdf"  type="application/pdf" width="125%" height="800px" />
        <br>
      </form>
    </div> 
    <!--mostrar pdf-->
