                      ...
                      <div class="accordion-body">
                        ...
                        <script>
...

                            {
                              ...
                              document.getElementById('020202').value = opciones[opcion][1];
                        ...
                        <form method="post"  class="row g-3">
                              ...
                              <label>Tipo de cotizacion:  </label>
                                ...
                                <div class = "col-md-4">
                                  <!--tipo de impuestos-->
                                  <a>Impuesto %</a>
                                  <br><input class="form-control text-end" type='text' id='020202' disabled readonly/>
                                </div>
...
function AgregarCampos(){
    ...
    campo = `<tr id="idLi${nextinput}">
            ...
            <!--Financiamiento-->
            <td><input  type="text" size="11" name="Fin[]" '  step="any" oninput="multiplicar(event);"></td>
